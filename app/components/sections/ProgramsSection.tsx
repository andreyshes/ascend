				...
				<div className="grid md:grid-cols-2 gap-px bg-[#1A1A1A]/50">
					{programs.map((program, index) => (
						<motion.div
							...
							className="group bg-[#0D0D0D] p-10 md:p-14 hover:bg-[#111111] transition-all duration-700 relative"
						>
							...
							<Link
								href={program.href}
								className="flex items-center gap-3 text-[11px] tracking-[0.2em] uppercase text-[#8A8A8A] group-hover:text-[#C9A96E] transition-colors duration-500"
							>
